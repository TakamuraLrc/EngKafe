...
function ContactSection() {
  return (
    <section className="px-4 md:px-10 py-16 bg-pink-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <p className="text-lg font-semibold text-gray-900">089 191 5555</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <p className="text-lg font-semibold text-gray-900">english.kafe@gmail.com</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              <a 
                ...
                title="LINE"
              >
                <img src={lineIcon} alt="LINE" className="w-12 h-12" />
              </a>
              <a 
          ...
          {/* Right Side - Map */}
          <div className="rounded-2xl overflow-hidden border-4 border-blue-300 shadow-lg">
            <iframe
